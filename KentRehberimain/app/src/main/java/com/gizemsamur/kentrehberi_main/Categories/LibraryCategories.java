...
public class LibraryCategories extends AppCompatActivity {
    ...
    private void AddComment() {
        Toast.makeText(LibraryCategories.this, "Yorumunuz için teşekkürler!", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(LibraryCategories.this, Comments.class));
    }
}